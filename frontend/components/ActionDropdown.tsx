...
const ActionDropdown = ({ file, onFileDelete, onFileRename }: { 
  ...
  console.log('🔍 ActionDropdown - emails state:', emails);
  console.log('🔍 ActionDropdown - file.users:', file.users);
  ...
  const handleAction = async () => {
    ...
    try {
      if (action.value === 'delete') {
        ...
        console.log('🔍 Share action - emails state:', emails);
        console.log('🔍 Share action - file.users before:', file.users);
        if (!file.$id) {
          throw new Error('File ID is missing');
        }
