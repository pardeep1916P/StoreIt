...
const SharedFilesList = () => {
  ...
  // Debug current state
  console.log('🔍 SharedFilesList render - isLoading:', isLoading, 'sharedFiles:', sharedFiles, 'length:', sharedFiles.length);
  ...
  const loadSharedFiles = async () => {
    try {
      ...
      console.log('🔍 Documents length:', result.documents?.length);
      setSharedFiles(result.documents || []);
      console.log('🔍 State updated with:', result.documents || []);
    } catch (error) {
