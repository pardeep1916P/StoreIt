...
const GlobalUploadPopup = () => {
  ...
  console.log('🔍 GlobalUploadPopup render:', { visible, filesLength: files.length, isUploading, uploadProgress });

  if (!visible || files.length === 0) {
    console.log('🔍 GlobalUploadPopup: Not rendering (not visible or no files)');
    return null;
  }
